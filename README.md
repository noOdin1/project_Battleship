...
| &emsp;&emsp;- Use Event Listeners to step through the game. The Event Listeners<br>&emsp;&emsp;&ensp;&nbsp;should use methods from other objects. If there is a need for a new<br>&emsp;&emsp;&ensp;&nbsp;function then a decision needs to be made about where this new<br>&emsp;&emsp;&ensp;&nbsp;function should be placed, which class/factory.<br>&emsp;&emsp;&ensp;&nbsp;<br>                                                                    | [in progress] :hourglass_flowing_sand: |
...
The following are the design criteria that I have put in place to work towards the objectives outlined above:<br>
| Designs                                                                                                            |          status           |
| ----------------------------------------------------------------------------------------------------------------------------- | :-----------------------: |
| 1. Create a function in 'Gameboard' class to take a 'Ship' object and paint<br>&emsp;the ship on the 'Gameboard'. <br>&emsp;Reason: The project page mentions that Gameboard call Ship class/factory<br>&emsp;to place the ship at specific locations.                                                                     | [in progress] :hourglass_flowing_sand: |
| 2. Define the ships that each player commands:<br>&emsp;&emsp;1. Battleship, count = 1, dimension 4 rows 1 column<br>&emsp;&emsp;2. Cruiser, count = 2, dimension 3 rows 1 column<br>&emsp;&emsp;3. Destroyer, count = 3, dimension 2 rows 1 column<br>&emsp;&emsp;4. Patrol Boat, count = 4, dimension 1 row 1 column.<br>                                                                     | [done] :white_check_mark: |
| 3. Each player is given/assigned a gameboard and a set/fleet of ships.<br>&emsp;&emsp; Each player class would contain a gameboard object and a set of ship<br>&emsp;&emsp;&nbsp;objects for each ship type mentioned above, player is composed of<br>&emsp;&emsp;'gameboard' and 'ship'.<br>                                                                     | [in progress] :hourglass_flowing_sand: |
